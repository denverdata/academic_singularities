...
The gravitational time dilation formula is t₁ = t₂√(1 - 2GM/rc²). As r approaches the Schwarzschild radius r\_s = 2GM/c², the term under the square root approaches zero, and t₁ approaches zero as a limit. Physicists claim "time stops" at the event horizon. But the limit is never attained—there is no r value where the equation actually equals zero for any finite time t₂. At every point r > 0, time continues at some non-zero rate. The error is treating lim(r→r\_s) t₁ = 0 as if it means t₁(r\_s) = 0, which is mathematically invalid.
...
The Fallacy of the Arbitrary

The fallacy of the arbitrary is actually really important because when we talk about physics it's commonly presumed that a thing like statements like 'big' or 'that's big' or 'that's small, infinitesimally small, extremely small' kind of terms fly around all the time, seemingly with intended meaning. In a relativistic universe they don't necessarily have meaning; they have meaning to us from our perspective, but that's a very human-centric way to look at things.

The fallacy is this: as we look at it, it comes down to just a mathematical problem but people maybe don't necessarily understand mathematics in certain cases, certain abstract cases. It's not that difficult and actually there are rules. We're all familiar with the division by zero; that's an error in math or calculators will generate, computers do it but it is very much an error in physics. Most equations are set against some kind of an equivalence point of zero or infinity. They either approach a limit of one or the other.

And what happens is as we get down toward that zero number, people get subjectively nervous about the value getting close to zero. It seems illogical that you could approach zero forever. It seems like it's just one little step away but it isn't. It's the same thing as the infinity on the other side; it's infinitely way away. So what happens is (and this is common and this is actually built right into physics and some of the deepest levels) is we assert some kind of a judgment call or we work some math. We assert a judgment call and then we either work math or we come back and declare blow up. I see both happen just as often. They're both two different explanations for the same goofy logic, the same presumption really.

And that is this: that once you get to something really small that's practically zero you toss a zero in there and then you look at your number and you go, "Oh my god, that's got that one over zero number as it approaches the limit of zero." That's really getting really little. We're going to hit zero. That's a judgment call because, again, that zero is no closer than infinity is; you'll never hit it. By definition you'll never hit that zero but people do. They get nervous and they say, "Oh we're going to get," and they get nervous and call it zero. They get foolish and call it zero because they think it's negligible or little or small and then once they do that they induce a mathematical error that really can't even occur in that domain.

The domain I'm talking about is floating point mathematics. In the world of floating point mathematics there is no such thing as an integer zero. There is but it's an infinitely precise zero with a repeating zero and that's infinitely hard to attain. It's impossible to attain in practicality so it's impossible to attain. Only by definition could it be attained; only by declaration could it be attained. Anything that those real world measurements would immediately drift from the first measurement you take by the lack of precision in your measurements.

So the other circumstance, where they don't declare it a zero, is the case where it gets very small and they don't declare it a zero. They declare it something that's not… it gets so small they think, 'Oh my God, it's just a divergence.' It doesn't mean anything. It has no more mathematical meaning. It somehow slips away once it starts going up, toward, if you're imagining a graph of 1/x versus x. When you get closer to zero on the x-axis, you get a sharp increase up to y. That doesn't mean that there's not a line there. In fact you could see it just goes a different direction but it's still a line; it goes to infinity. You'll never get to zero just like you'll never get to infinity. Neither is a finite number. They both represent the absence of a boundary in that direction, zero being one boundary and infinity being the other. So those are two ideal numbers that bound a finite realm of numbers here.

So no neither of those are true. You can actually, for every one of those equations, to my knowledge, you can continue to use the mathematics.

The third point I hear often claimed that doesn't have anything to do with zeros is Planck's Planck constant. Planck scale or Planck time, all kinds of different things. Planck never asserted that was a minimum of any kind. I don't think that it was ever understood that it is. It has something to do with the point at which your observation becomes statistical and you have to rely on quantum mechanics to explain things from our scale. That's not a different realm. That's not a different regime. That is a coexisting observational phenomenon, just like, honestly, the way we see things immediately around us is an observational phenomenon, just a different one. One that we're really, really comfortable with. Both are accurate at all scales. We have a really hard time looking at ourselves from a quantum perspective because it requires a whole lot more data than we could ever see of ourselves. We can see what it means when we look at things that are really tiny and that move really fast.

So, as you can imagine, to strike a boundary, an artificial boundary in mathematics and physics, which is the next argument actually. The next argument goes, no, mathematics and physics aren't the same thing. They're different. No, they're not. They're not actually. Physics, the natural world, is a universe of infinite detail, infinite precision. And any measurement we can take is infinitely precise. Everything in the universe has an infinitely precise measurement. But we don't have the ability to measure that level of precision. Not even at all. We get a couple of digital figures. We don't get infinity figures, we get a couple of digital figures. It's a very big difference. Mathematics is modeled after the natural world. We didn't cook up math separately. It is our model of the natural world. That's how that's what we that is our model of the natural world mathematics and it's not always exactly right but for the most part our model's pretty accurate it's only going to deviate in our inability to do math well honestly.

So that there, in a nutshell, is the fallacy of negligibility: that there is never anything that's negligible. To look at it that way, to say the word "that's big" or "that's small" or "that's little" says that you don't understand the relative nature of the universe, that you're seeing it from your perspective. Physics has been riddled with that same problem. Everything from seeing the Earth as flat to seeing Earth as the center of the universe to any number of other things goes on today. We still impart problems into the way we see the universe because we draw boundaries where we don't know they are. The reason is pretty simple: we are humans and so we do see things from a human-centric perspective and it's hard to step outside of that. But we've proven again and again that if we can we can describe things a lot more effectively.

So a common human tendency is to say, 'If we haven't observed it, there's no reason to say it exists,' like it's a ghost or something. When in reality if we've got a trajectory of principles that we're watching and we say, 'Oh this trend looks really consistent,' like it seems like waves get bigger and smaller in both directions. We don't have any reason to see that thing that they stop. Then there's no reason to believe they stop even if we can't see where they stop. Now if there's a reason to believe that our observation is accurately saying they're not there, that's a whole different story.

So it's a bigger leap of faith to say that what we haven't observed doesn't exist than it is to say that what we have observed is consistent with what we haven't observed.

Yet we choose the former.

So the effect is that we mislead ourselves about the nature of the universe and then get frustrated when we can't take our story further. That particular thing, this particular thing, presumed something goes to zero. It applies with gravitational black holes. Once you get gravitational collapse first, it's presumed that the black hole itself is the event horizon, the part that we can see where the light stops. That's the Schwarzschild radius. That's correct but that's not a singularity. That's what they refer to as a coordinate singularity. That's not where time stops. In fact the formula says that's where time stops. That's not correct. That imparts a big error into what is otherwise a very accurate general relativity because they just stuffed it as zero.

We know that behind that event horizon is a thing that continues to get smaller because we try to call it a singularity, a real one. So we know it gets smaller, and we know that it gets smaller behind that event horizon that we can't see through. The one thing we know about the event horizon is we can't see through it. The other thing we know is that time is surely going slower for the things that are inside of that event horizon than they were going for the event horizon itself. So, it wasn't the limit of slow. In fact, there is not a limit of slow. There's no such thing as 100% time dilation nor zero time dilation. Those would be fallacies. Those would be to presume that the limit could be attained, and they cannot.

Now there is a theorem developed by Hawking and Penrose in 1965 that does describe the inevitability of a singularity in general Relativity and they did kind of shove that on Relativity after. Mr. Einstein, Dr. Einstein, passed away 10 years prior to that. I don't think it was what Einstein believed went on in the universe; however he was led to believe that cosmic expansion was the only possible explanation for the redshift that we see in the cosmos and that isn't 100% honest. It's not necessarily proven to be the case. I know that that's… I understand the rigor with which that's been tested but I also know something on the matter and there are other things that would explain it.

My point being, not that I'm going to try and explain it right now, but that there is potential for something to explain it better and it has not been a seamless set of predictions. It has not in any way. It's adequate at best.

The Conclusion of Cosmic Expansion was a reactionary or reactive hypothesis to start with. It's tested okay; most of it, most of the data, most of the premise was built under the same set of data that it was fed; that's its premise because they wanted to. It wasn't predicted so they had to build them out, a lot of the observations. It said things are expanding and they thought that was gonna be consistent and they looked further out in space with a different telescope. They went, "Oh my god, things were really starting to actually accelerate out there," and they're gonna continue to see something that feels like that. They also see phenomena that describe different parts of systems going faster and slower, sometimes coming closer to you. These are not real phenomena that you would see in an expansion model. There's a lot of evidence that's built up around it, the CMB and the cosmological principle. These are things that were literally utilized the cosmic expansion as their premise and they would surely support it if that were the case. These are all the things that were reactive, double two degrees of separation, reactive. They weren't even reacting to the primary phenomena; they're reacting to the explanations of the phenomena. The singularity is another one that is a secondary reactive explanation and you can imagine the can of worms that opens from there. We've seen it. We don't know what our universe does at all. That's because we're not looking at it like serious people.

Point being there have been and there will continue to be things that we think we have figured out that are just not exactly true. That's not a bad thing; that's how you learn but my point being it doesn't lead to a singularity so let's talk about the singularity at the Big Bang that is absolutely implied with expansion, absolutely. As with any asymptote relationship you can claim that t equals zero exists but it would be hard to claim that we ever were at t equals zero. The best way you could explain it would be that we always and forever emerged from t equals zero and that we never really were there. We approached it, which means we've always been here. Further if you were to describe it in that fashion, then really what you're just saying is a universe of infinite precision, of ever increasing precision as it contracts, same mass. In other words you've got the same universe that if you were in that universe you would never see a change; it's the same universe. It's just a scaling universe so I would contend that you just have the same universe forever and that's just the same thing as saying there's an infinity of time used. Expansion doesn't really draw that conclusion, which is okay but they named it the Big Bang that really kind of backs them in the corner. I digress.

But the simple fact is calling it a singularity is a mathematical fallacy in every circumstance. To call it a thing that's breaking down is not accurate. What I commonly hear is the Planck scale, which I mentioned a minute ago. The Planck scale is cited as the reason why you have to go to another system or why you can't rely on the results for that because you're not in the quantum world. That is true but it doesn't mean you switch to a different regime. These are not different regimes per se. As I said everything, if you think about it in classical terms, from our scale or from the scale of the observer or from the scale of the system, every single scale in the universe looks the same and feels the same. The physics are the same. Time's the same. The difference is that other systems look different relative to you and if you got bigger then everybody else stayed the same. Larger systems start to get smaller relative to you. Eventually they'd get to be little relative to you and things that used to be little would vanish into the distance or into microscopic particles.

So yeah it doesn't but here's the other thing. It's the quantum. Quantum emerges because of the way we observe things. Quantum again is an observational phenomenon when it comes to trying to observe things below the scale of the smallest thing we can detect with light, which is molecules. That's what we use a molecule to detect light. That's the smallest we're going to get when it comes to detecting light. We don't have a mechanism for detecting smaller things. If we used subatomic matter for that mechanism, we'd be able to see something finer-tuned than that but we can't. So we don't get to use microscopes or anything else. We have to go to indirect measurement. Indirect measurement amounts to seeing very different things. If you imagine, for example, looking in a microscope, you're looking at a virus or a cell or an insect or whatever, anything, air, a number of things, whatever you want, a piece of rock. We think of all those things as discrete objects. When you're in the quantum world we know that we look at discrete objects kind of. We know that we look at objects but they are not discrete. They are random objects of a certain genus, for example, that have certain properties but the standard deviation among those particles for those properties is extremely wide. Extremely wide. Furthermore they move extremely fast; they have an extremely much higher time scale, a faster time scale than we do. By the time we come back and take a second measurement a long time has passed. Those particles may not exist in the same form any longer. That's why to observe them is to bleach them currently because it vanishes. If you had one particle there you might be able to do it but that particle would last a million years on its time scale or a billion years on its time scale, which they do. You also get a weird representation because there's no such discrete object as something you're only measuring when you grab a sample. That's what you're measuring: a discrete object that is among a statistical community, which means you're going to get really weird answers. You'll never measure that same particle again so you might get two left arms even though you think you're measuring the same person twice.

That would seem bizarre but it couldn't possibly be the same person in the world that I'm talking about. Even milliseconds apart in sampling is still eons to a molecule or smaller.

That is the fallacy of the negligible or of the arbitrary. The same thing goes for the other end of general Relativity. General Relativity compares your time dilation against yourself at arbitrarily large radius to kind of signify the part of the universe where there is no gravity. Well that's not realistic; there's no zero gravity. It's a continuum; it goes to infinity and zero and you can have that much time dilation. You can either be totally time dilated (which you'll never get to) or you can be zero time dilated (that's infinity; we'll never get to it). Those are limits; they're not numbers or values. Every discrete number between the two, every single finite number between the two, those formulas all work for all the way down to 1×10^(-googol) or 10^(-googol^googol).

So you can imagine that arbitrarily large starts to take on an odd meaning. If you take the gravitational time dilation figure and you put in a mass and you back-calculate by moving the t2 to the other side and put it back in and shuffle the numbers with the formula around, what you'll get is a number for r2 and a number for your radius too. That arbitrarily large number will be something like 10 to the 24th or something like that. It might not even be that big. If you go back and put in a number of masses, an order of magnitude larger than that last one, you get a very different arbitrarily large number that might be an order of magnitude larger. Which tells you that you're not really getting the numbers all that accurate. In fact it's even more distorted than that. You wouldn't get the nice clean ratio; it's not that ratio. Which means if they then take those two numbers and divide one by the other to just get the relative time dilation of these two states of the system, say we're comparing the International Space Station versus the surface of the Earth, we're not going to get the right answer. We're going to wonder why our prediction's wrong. Well because the formula doesn't work that way. We compared two numbers that have a different number on the bottom because we generalised. We took a relativistic formula and contrived some goofy version of the thing we're comparing it to.

So how do you do that properly? Well to further the confusion we then import more zeros and ones. We then subtract it from one, take the square root, and that is to normalize it. Normalizing is like the ultimate human-centric move because it just brings it right around to wrap around us but it doesn't even sound so confusing. It does but it kind of doesn't. They try to but it's so frickin' confusing when they do that calculation. It is the most confusing. If you just had 1 to infinity, that'd be really useful as a ratio of time in one system versus time in the other, ratio of time at this big radius versus time at the little one. You could derive a lot from those two. You don't have to fix it up; you know? Yeah it's okay to have a tangible arbitrarily large and just think about that instead but you can't go with zero. You cannot not get an error. It speaks to a big error, a big fallacy that prevents you from getting the right number with your gravitational time dilation. I can take my inertial relationships and plug it in and I will get the same, I can numerically get the same answer if I impart the same fallacies. I can get the same answer as General and Special Relativity get. Special Relativity is not being indicted here or anything but General is missing something. Special is too. They both are and it's all in the department of zeros and infinities. You would think those are not big things but they are really big things because it changes how you interpret the entire universe. You overcomplicate things so much more when you start to believe that.

It's not a little fallacy to think that it switches to another domain when it doesn't. Just think that there are two different domains when there aren't. To not know that they are complementary, that they are both correct all the time, and they just represent two different views of the same thing clouds our mind. These aren't that hard to accept. It would be impossible, it'd be very difficult to make.
